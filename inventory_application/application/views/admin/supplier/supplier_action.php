...
if($supplierUpdate->num_rows()>0){
	foreach($supplierUpdate->result() as $supplier);
		...
		$passwordHints=$supplier->passwordHints;
		$website=$supplier->website;
		$urlname=$supplier->urlname;
  ...
  <div>
     <div class="page-title">
                        <div class="title_left">
                            <h3>suppliershop Registration Details</h3>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>suppliershop Registraion Form</h2>
