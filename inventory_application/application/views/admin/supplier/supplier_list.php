...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>ouradminmanage/approvedsupplier?approve_val="+data;
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>ouradminmanage/deapprovedsupplier?deapprove_val="+data;
			window.location.href=hrefdata;
	}
                        ...
                        <?php echo form_open('', 'name="formUserSearch" id="form_check"');?>
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <a href="<?php echo base_url('ouradminmanage/supplier_registration');?>" class="btn btn-primary">New supplier Shop</a>
                                ...
                                <div class="container">
                                  <table class="table table-striped" width="100%">
                                   ...
                                   foreach($supplierlist->result() as $supplier):
										...
										$editorName=$supplier->editorName;
									...
									?>
                                      <tr>
                                        ...
                                        <td width="9%" align="left">
                                         ...
                                         <td> 
                                         	<a href="<?php echo base_url('ouradminmanage/supplier_registration/'.$supplier_id);?>" class="btn btn-default btn-sm">
