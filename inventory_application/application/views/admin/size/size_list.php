                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('ouradminmanage/size_registration');?>" class="btn btn-primary">New size</a></h2>
                                    <div class="clearfix"></div>
                                ...
                                <div class="container">
                                  <table class="table table-striped">
									...
									$cateQuery = $this->Index_model->getAllItemTable('category','cid',$cat_id,'','','cid','desc');
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $catWiseSize; ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('ouradminmanage/size_registration/'.$size_id);?>" class="btn btn-default btn-sm">
