                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('ouradminmanage/membership/newmember');?>" class="btn btn-primary">New Member</a></h2>
                                    <div class="clearfix"></div>
                ...
                function dob($edate)
					...
					foreach($memberList->result() as $member): $pageSl++; 
							...
							if($expdate!=""){
								if($interval < 0){
									...
									$edate = new DateTime($currentDate);
									$diffD = $sdate->diff($edate)->format("%a");
									$interval=$diffD;
									$c="red";	
									$class="blink_me";
									$duetime = $interval.' Days';
								}
								elseif($interval > 0){
									$c="green";
									$class="";
					...
					?>
                                      <tr>
                                        ...
                                        <td><strong style="color:<?php echo $c;?>"><?php echo $duetime; ?></strong></td>
