...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>ouradminmanage/approve?approve_val="+data+"&tablename=category"+"&id=cid"+"&status=status";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>ouradminmanage/deapprove?approve_val="+data+"&tablename=category"+"&id=cid"+"&status=status";
			window.location.href=hrefdata;
	}
...
window.location.href='<?php echo base_url();?>ouradminmanage/sequenceManage?sequence='+updateid+"&&id="+id+"&tbl=category"+"&tid=cid";
}
...
<div class="right_col" role="main">
                        ...
                        <?php echo form_open('', 'name="formUserSearch" id="form_check"');?>
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <a href="<?php echo base_url('ouradminmanage/category_registration');?>" class="btn btn-primary">New Category </a>
                              ...
                              <div class="x_content">
                                ...
                                <div class="container">
                                  <table class="table table-striped" width="100%"> 
									...
									$supplier=$categoryData->class_id;
									
									$butikque=$this->Index_model->getAllItemTable('classes','cid',$supplier,'','','cid','desc');
									if($butikque->num_rows() > 0){
										foreach($butikque->result() as $butikrow);
										$shopName=$butikrow->class_name;
									}
									else{
										$shopName=$supplier;
										}
        ...
        <input type="button" id="update" value="Save" style="width:30%;float:left" class="btn btn-primary" onclick="update_sequence(<?php echo $cid;?>);" />
                                        ...
                                        <td width="11%" align="left">
                                         ...
                                         <td> 
                                         	<a href="<?php echo base_url('ouradminmanage/category_registration/'.$cid);?>" class="btn btn-default btn-sm">
