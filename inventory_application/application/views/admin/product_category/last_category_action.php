                                   ...
                                   <div id="registration_form">	
                                        ...
                                        <div class="panel panel-default">
                                          ...
                                          $queryImg=$this->Index_model->getAllItemTable('supplier','user_id',$boutique,'','','user_id','desc');
											...
											?>
                                                <select name="supplier" id="supplier" class="form-control col-md-7 col-xs-12" required>
                                           ...
                                           <label class="control-label col-md-3 col-sm-3 col-xs-12">Product Category<span class="required">*</span>
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                ...
                                                onChange="getCategory('<?php echo base_url();?>ouradminmanage/ajaxCategory?cat_id='+this.value);" required>
