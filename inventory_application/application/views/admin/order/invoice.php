                            ...
                            <div class="x_panel">
                              ...
                              <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-5 col-sm-offset-4">
                                      ...
                                      <a href="<?php echo base_url('ouradminmanage/invoice/'.$inv_id.'/?status=print');?>" onclick="javascript:void window.open('<?php echo base_url('ouradminmanage/invoice/'.$inv_id.'/?status=print');?>','','width=1200,height=600,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=100,top=30');return false;"><i class="fa fa-print"></i> Print</a>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                <h2>Invoice Number # <?php echo $inv_id;?></h2>
